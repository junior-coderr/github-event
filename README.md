...
On the home page, use the category checkboxes and publisher selector to narrow the game listing. Multiple categories can be selected together, and active filters are preserved in the URL.
