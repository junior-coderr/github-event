...
- Comments should explain test intent or a non-obvious fixture decision, not restate the assertion. Keep test comments current when the behavior under test changes.
